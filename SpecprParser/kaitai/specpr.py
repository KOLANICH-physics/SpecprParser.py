...
class Specpr(KaitaiStruct):
    ...
    class DataInitial(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.ihist = (KaitaiStream.bytes_strip_right(self._io.read_bytes(60), 32)).decode(u"ascii", errors="ignore")
            self.mhist = [None] * (4)
            for i in range(4):
                self.mhist[i] = (self._io.read_bytes(74)).decode(u"ascii", errors="ignore")
    ...
    class Identifiers(KaitaiStruct):
        ...
        def _read(self):
            self.ititle = (KaitaiStream.bytes_strip_right(self._io.read_bytes(40), 32)).decode(u"ascii", errors="ignore")
            self.usernm = (self._io.read_bytes(8)).decode(u"ascii", errors="ignore")
    ...
    class TextInitial(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.itext = (self._io.read_bytes(1476)).decode(u"ascii", errors="ignore")
    ...
    class TextContinuation(KaitaiStruct):
        ...
        def _read(self):
            self.tdata = (self._io.read_bytes(1532)).decode(u"ascii", errors="ignore")
